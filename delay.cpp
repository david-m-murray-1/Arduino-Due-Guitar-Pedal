...
void Delay::Delay_init(double delay_samples, double dfb, double dfw, double dmix) {
...
void Delay::set_fb(double val) {
	del.dfb = val;
}

void Delay::set_fw(double val) {
	del.d_fw = val;
}
		
void Delay::set_mix(double val) {
	del.d_mix = val;
}
